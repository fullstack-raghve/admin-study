...
import { Bank, BANKS } from '../../../shared/components/add-multiselect/demo-data';

@Component({
  selector: 'app-multiple-selection-select-all-example',
  templateUrl: './add-multiselect.component.html',
  styleUrls: ['./add-multiselect.component.scss']
})
export class AddMultiselectComponent implements OnInit, AfterViewInit, OnDestroy {
