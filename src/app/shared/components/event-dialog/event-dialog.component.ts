...
export class EventDialogComponent implements OnInit {
 ...
 public displayedColumns: string[] = ['select', 'eventId','eventName','BRAND_NAME', 'rewardType','eventStartDate','eventEndDate'];
