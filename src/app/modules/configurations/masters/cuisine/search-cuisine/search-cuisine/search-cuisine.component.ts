...
@Component({
  ...
  templateUrl: './search-cuisine.component.html',
  styleUrls: ['./search-cuisine.component.scss']
})
export class SearchCuisineComponent implements OnInit {
  ...
  displayedColumns: string[] = ['cuisineCode', 'cuisineName', 'createdOn', 'lastModifiedBy', 'lastModifiedOn', 'status'];
  ...
  public buildSearchForm() {
    this.searchCuisineForm = this.fb.group({
      status: [""],
      searchVal: [""]
    });
  }
