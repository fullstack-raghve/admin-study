...
@Component({
  selector: 'search-customer-type',
  templateUrl: './search-customer-type.component.html',
  styleUrls: ['./search-customer-type.component.scss']
})
export class SearchCustomerTypeComponent implements OnInit {
  ...
  displayedColumns: string[] = ['customerCode', 'customerTypeTitle', 'type','createdOn', 'lastModifiedBy', 'lastModifiedOn', 'status'];
