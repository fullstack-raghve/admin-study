...
@Component({
  selector: 'view-customer-type',
  templateUrl: './view-customer-type.component.html',
  styleUrls: ['./view-customer-type.component.scss']
})
export class ViewCustomerTypeComponent implements OnInit {
