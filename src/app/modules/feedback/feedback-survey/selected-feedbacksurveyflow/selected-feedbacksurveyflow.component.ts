...
@Component({
  selector: 'app-selected-feedbacksurveyflow',
  templateUrl: './selected-feedbacksurveyflow.component.html',
  styleUrls: ['./selected-feedbacksurveyflow.component.scss']
})
export class SelectedFeedbacksurveyflowComponent implements OnInit {
    ...
    if (this.searchFlowFormGroup.invalid == false) {
      ...
      let data =
      {
        ...
        "fieldSearch": [
          ...
          {
            "brandOid": this.SurvyeData.brandId.toString(),
            "countryOid": this.SurvyeData.countryId.toString(),
          }
        ]
      ...
      this.https
        .postJson(
          environment.APIEndpoint + "api/rpa/feedback/flow/v3/search",
          data
        )
        .subscribe(
          res => {
