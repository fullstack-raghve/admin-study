...
@Component({
  selector: 'app-incomplete-reports',
  templateUrl: './incomplete-reports.component.html',
  styleUrls: ['./incomplete-reports.component.scss']
})
export class IncompleteReportsComponent implements OnInit {
  ...
  searchVal() {
    ...
    if (this.searchFeedBackForm.invalid === false) {
      ...
      this.https.postJson(environment.APIEndpoint + 'api/rpa/feedback/report/v1/incompleteFeedbackReport', data).subscribe(res => {
  ...
  public exportAsExcel() {
    ...
    /* save to file */
    XLSX.writeFile(wb, 'Dropoff_Summary.xlsx');
  }
  ...
  feedbackReportTotal() {
    if (this.searchFeedBackForm.invalid === false) {
      ...
      this.https.postJson(environment.APIEndpoint + 'api/rpa/feedback/report/v1/incompleteFeedbackReportTotalValue', data).subscribe(res => {
