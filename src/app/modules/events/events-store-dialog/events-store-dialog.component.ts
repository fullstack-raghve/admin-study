...
@Component({
  selector: 'app-events-store-dialog',
  templateUrl: './events-store-dialog.component.html',
  styleUrls: ['./events-store-dialog.component.scss']
})
export class EventsStoreDialogComponent implements OnInit {
